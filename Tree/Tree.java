...
class Node{
    ...
    public void levelOrder(){
        ...
        levelWisePrinting(root, list);
        System.out.println(list);
    }
    public List<List<Integer>> levelWisePrinting(Node root, List<Double> list) {
    ...
    public  boolean symmetricity(Node node1, Node node2){
        ...
        return symmetricity(node1.left,node2.right) && symmetricity(node1.right,node2.left);
    }
